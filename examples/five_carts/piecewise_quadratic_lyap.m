...
bon = 0.1;
bnd = zeros(n+m+1); bnd(1:n,1:n) = eye(n); bnd(end) = -bon; bnde = zeros(n+2*m+1); bnde(1:n,1:n) = eye(n); bnde(end) = -bon;
t1=sdpvar(1,1); t2=sdpvar(1,1); t3 = sdpvar(1,1); F = [F, t1 >=0, t2 >=0, t3 >= 0];
